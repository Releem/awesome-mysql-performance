...
- [MySQL Tuning: Getting the most out of your database](https://www.databasedesign-resource.com/mysql-tuning.html)
...
- [Thread Pool](https://docs.percona.com/percona-server/5.7/performance/threadpool.html#thread_handling)
### thread_pool_size
...
- [Server System Variables - transaction_prealloc_size](https://dev.mysql.com/doc/refman/8.4/en/server-system-variables.html#sysvar_transaction_prealloc_size)
### table_open_cache
